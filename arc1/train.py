...
model = Sequential()
model.add(Conv2D(128, kernel_size=9, padding='same', activation='relu', use_bias=True, input_shape=(128,128,1)))
model.add(Conv2D(64, kernel_size=9, padding='same', activation='relu', use_bias=True))
model.add(Conv2D(32, kernel_size=5, padding='same', activation='relu', use_bias=True))
model.add(Conv2D(1, kernel_size=5, padding='same', activation='relu', use_bias=True))
